...
export default function Create({onHandleSubmit}) {
    ...
    return (
        <form onSubmit={onSubmit}>
            ...
            <input className="colorTextInput" name="colorTextInput" type="text" value={color} onInput={(event)=>handleSetColor(event.target.value)} maxLength="7" pattern="^#([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$" title="3- or 6-digit hexcode. Only numbers and letters from A-F."/>
